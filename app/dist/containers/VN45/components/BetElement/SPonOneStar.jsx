      ...
      <div styleName="col-xs-12 ball">
        <div styleName="nav-content">
          <div styleName="game-holder text-center">
                ...
                .map((item, i) => {
                  return (
                    <div key={`OneStarTitle${i}`}>
                      <div styleName="s1-title-number">號碼</div>
                      <div styleName="s1-title-price">本金</div>
                      <div styleName="s1-title-order">下注金額</div>
                    </div>
                  );
                })}
            </div>
            <div
              styleName="clearfix"
              style={{ display: 'flex', width: '100%', height: 530 }}>
              <div styleName="col5">
                <div id="fastchoose">
                  <div styleName="fastframe">
                    ...
                    <div styleName="input-group">
                      ...
                      <input
                        ...
                        ref={el => {
                          this.inputRefsNum = el;
                        }}
                        onKeyUp={e => {
                          this.inputRefsNum.value = this.inputRefsNum.value.replace(
                            /\D/g,
                            ''
                          );
                          while (this.inputRefsNum.value.length > 2) {
                            this.inputRefsNum.value =
                              (this.inputRefsNum.value / 10) >>> 0;
                          }
                          if (
                            this.inputRefsNum.value.length == 2 ||
                            (this.inputRefsNum.value.trim() &&
                              e.key === 'Enter')
                          ) {
                    ...
                    <div styleName="input-group">
                      ...
                      <input
                        ...
                        styleName="form-control"
                        ref={el => {
                          this.inputRefsMoney = el;
                        }}
                        onKeyUp={e => {
                          this.inputRefsMoney.value = this.inputRefsMoney.value.replace(
                            /\D/g,
                            ''
                          );
                          if (
                            this.inputRefsMoney.value.trim() &&
                            e.key === 'Enter'
                          ) {
                            let newInputMoney = this.state.inputMoney;
                            newInputMoney[
                              this.inputRefsNum.value - 1
                  ...
                  <div styleName="fastframe">
                    ...
                    <div styleName="input-group">
                      ...
                      />
                      <span styleName="whiteblock" />
                      <span
                        styleName="inputname input-group-addon submittt"
                        onClick={this.addChoosedMoney(storeData)}>
                        送出
                      </span>
                    </div>
                  </div>
                  <div styleName="fastframe">
                    <div styleName="chooseItem">
                      <span
                        styleName="btn btn-link"
                        onClick={this.fastChooseBall(1, 45, 2)}>
                        單
                      </span>
                      <span
                        styleName="btn btn-link"
                        onClick={this.fastChooseBall(2, 45, 2)}>
                        雙
                      </span>
                      <span
                        styleName="btn btn-link"
                        onClick={this.fastChooseBall(23, 45, 1)}>
                        大
                      </span>
                      <span
                        styleName="btn btn-link"
                        onClick={this.fastChooseBall(1, 22, 1)}>
                        小
                      </span>
                    </div>
                  </div>
                  <div styleName="fastframe nodata" />
                </div>
              </div>
                  ...
                  .map((item, index) => {
                    return (
                      <div styleName="each-ball" key={`ball${index}`}>
                        <input
                          type="checkbox"
                          checked={storeData.includes(index + 1)}
                          readOnly
                        />
                        <label
                          styleName="m_ball_y"
                          onClick={this.chooseBall(index + 1)}>
