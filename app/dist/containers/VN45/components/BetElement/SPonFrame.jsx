          ...
          <div styleName="game-holder text-center">
            ...
            <div styleName="row full">
              ...
              <div styleName="col-xs-6">
                <a styleName="btn-add btn-block" onClick={this.bettingSlip}>
                  加入這一筆單碰
                </a>
              </div>
              <div styleName="col-xs-6">
                <a styleName="btn-clear btn-block" onClick={this.clearAllInput}>
                  清除號碼與金額
                </a>
              </div>
              <div styleName="col-xs-12">
                <a
                  styleName="btn-clearall btn-block"
                  onClick={this.clearAllBetting}>
                  清除所有的單碰
                </a>
              </div>
              <div styleName="subtitle row full">
                <div styleName="flex">
                  {nowStar.map((item, index) => {
                    return <HashNum key={`HashNum${index}`} />;
                  })}
              ...
              {this.state[`S${star}`].length == 0 ? (
                <div styleName="col-xs-12 nodata">沒有資料</div>
              ) : (
                <SPonList data={this.state[`S${star}`]} />
              )}
            </div>
            <Dialog
              actions={actions}
