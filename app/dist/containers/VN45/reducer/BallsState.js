export default function(state:{CheckedBall:Array,nowColum:number,ColumBalls:Array} = {CheckedBall:[],nowColum:0,ColumBalls:[[],[]]}, action) {
        ...
        case 'CHOOSE_BALL':
            ...
            if (haveAll) {
                ...
                if (gameType == 'C'){
                    ...
                    let allColumnHaveBall = newColumBalls.every((item)=>(item.length !== 0));
                    (allColumnHaveBall == true) && (newColumBalls = [...newColumBalls,Array()])
                }
            }
            return {
