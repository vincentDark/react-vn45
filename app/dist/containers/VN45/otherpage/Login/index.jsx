        ...
        return (
            <div id='login-page'>
                <form id="uLogin" name="kk" method="POST" action="">
                    ...
                    <div styleName="wrap">
                        <div styleName="new-logo"><img src={Logo}/></div>
                        <div styleName="logingroup member logingroup_zh-TW">
                            ...
                            <div styleName="btn1" onClick={this.enter}>會員登入</div>
                        </div>
                        <div styleName="textgroup2">
                            ...
                            <span styleName="btnLink">
                                <span>下載</span>&nbsp;
                                <a href="http://download.teamviewer.com/download/TeamViewerQS_zhtw.exe" id="teamviewer">遠端程式</a>
                            </span>
                            <span styleName="btnLink" style={{borderReftWidth:0}}>
                                <span>下載</span>&nbsp;
                                <a href="/DeleteCookie.php" target="_blank">清除緩存</a>
                            </span>
                        </div>
                    </div>
                </form>
                ...
                <div styleName="mega645"><img src={Mega} alt=""/></div>
            </div>
        );
    }
}
