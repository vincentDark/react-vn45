            ...
            <div styleName="col-xs-7">
                <form styleName="form-horizontal" id="gateway">
                    ...
                    <div styleName="form-group">
                        ...
                        <div styleName="col-sm-8">
                        <textarea styleName="form-control" name="message" rows="6"></textarea>
                        </div>
                    </div>
                    <input type="hidden" name="action" value="mw" />
                    <div styleName="form-group">
                        <div styleName="col-sm-12">
                        <button type="button" styleName="btn btn-default pull-right">確定</button>
                        <button type="reset" styleName="btn btn-default pull-right">重填</button>
                        </div>
                    </div>
                </form>
            </div>
